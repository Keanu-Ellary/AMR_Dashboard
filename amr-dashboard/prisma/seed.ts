  ...
  await prisma.adminUser.createMany({
    data: [
      ...
      },
      {
        ...
        isAdmin: true,
        password:
          "$2b$10$ZIgV5nJyyRBvIoIUKy577.5pCF0WgDL1gtwO0PXWoq1RL6lIU//Se",
      },
      {
        name: "Tony",
        surname: "Stark",
    ...
    data: [
      {
        ...
        password:
          "$2a$10$wm7BNrOIxDcyXNCg1lRKdePG6PnowlE8pUyn2YwaBJdd/0neDuu4a",
      },
      {
        name: "Alice",
        surname: "Map",
        ...
        password:
          "$2a$10$Q7BL50faig/TfvElda6JrOGXqRcpeI2tUpg/5FCtu4cZQHYqiMbMy",
      },
      {
        name: "Test",
        surname: "User",
